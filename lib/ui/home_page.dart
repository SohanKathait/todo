...
class HomePage extends StatelessWidget {
  ...
  //We load our Todoo BLoC that is used to get
  //the stream of Todoo for StreamBuilder
  final TodoBloc todoBloc = TodoBloc();
  final String title;

  //Allows Todoo card to be dismissable horizontally
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (newTodo.description.isNotEmpty) {
                                    /*Create new Todos object and make sure
                                    the Todos description is not empty,
  ...
  Widget getTodoCardWidget(AsyncSnapshot<List<Todo>> snapshot) {
    ...
    if (snapshot.hasData) {
      ...
      but returned returned 0 records of Todos from DB.
              ...
              itemBuilder: (context, itemPosition) {
                ...
                final Widget dismissibleCard = new Dismissible(
                  ...
                  onDismissed: (direction) {
                    /*The magic
                    delete Todos item by ID whenever
                      ...
                      child: ListTile(
                        leading: InkWell(
                          onTap: () {
                            ...
                            /*
                            Another magic.
                            This will update Todos isDone with either
                            completed or not
                          */
